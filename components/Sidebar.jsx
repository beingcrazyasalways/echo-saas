...
export default function Sidebar({ currentEmotion }) {
  ...
  return (
    <div className="w-72 h-screen backdrop-blur-xl bg-slate-900/50 border-r border-white/10 flex flex-col fixed left-0 top-0">
